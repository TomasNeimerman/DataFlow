...
function mapReciboToSDK(recibo) {
  ...
  return {
    ...
    Comprobante_AsociadoAnulado: null,
    Comprobante_AsociadoPeriodoDesde: null,
    Comprobante_AsociadoPeriodoHasta: null,
    Comprobante_ProvinciaIIBB: null,
    Comprobante_Empresa: null,
    Comprobante_Sucursal: null,
    Comprobante_ID: recibo.id || 656,
    Comprobante_IDMediosPago: recibo.idMediosPago || 726,
    Comprobante_ValidarKit: null,
    Comprobante_Items: [],
