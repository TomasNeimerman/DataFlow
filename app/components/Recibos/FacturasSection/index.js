                      ...
                      <td className={styles.tdRight}>
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            const cap = Math.max(
                              0,
                              Math.min(val, topeFactura, restanteCliente)
                            );
                            setAplicaFact((prev) => ({
                              ...prev,
                              [idx]: { checked: true, monto: cap },
                            }));
                          }}
                        />
                      </td>
